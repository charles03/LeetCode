...
public class ConsistentHashing {
    public static int SIZE = 360;

    public List<List<Integer>> consistenHashing(int n) {
        ...
        for (int i = 1; i < n; i++) {
            ...
            index = 0;
            // loop to find index of machine which size is large than first one
            for (int j = 1; j < i; j++) {
            ...
            // re-size current machine
            res.get(index).set(1, (x + (y - x) / 2));
    ...
    public static void main(String[] args) {
        ...
        System.out.println(hashing.consistenHashing(5));
    }
